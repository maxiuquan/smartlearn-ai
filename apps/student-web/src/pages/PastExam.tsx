...
const PAPER_OPTIONS: PaperOption[] = [
  { file: '/exam-papers/math1-exams.json', title: '考研数学一真题', emoji: '🔢' },
  { file: '/exam-papers/math2-exams.json', title: '考研数学二真题', emoji: '➗' },
  { file: '/exam-papers/english1-2-exams.json', title: '考研英语真题', emoji: '📖' },
  { file: '/exam-papers/cet4-6-exams.json', title: '英语四六级真题', emoji: '🎓' },
];
