...
from app.api.v1.rag_admin import router as rag_admin_router
...
# 内容版权台账与下架机制（P0-5）
api_router.include_router(content_router, prefix="/content", tags=["内容版权"])
# RAG 持久化索引管理（P1-2）— 路由内部已带 /rag/admin 前缀
api_router.include_router(rag_admin_router, tags=["RAG 索引管理"])
