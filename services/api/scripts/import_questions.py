...
_DATA_CANDIDATES = [
    os.path.join(os.path.dirname(__file__), "..", "..", "..", "data", "questions"),  # 本地开发
    os.path.join(os.path.dirname(__file__), "..", "data", "questions"),  # 容器内 /app/scripts -> /app/data
    "/app/data/questions",  # 容器内绝对路径兜底
]
